...
from icloud_photo_sync.config import get_config, BaseConfig, KeyringConfig, EnvOnlyConfig, KEYRING_AVAILABLE
...
class TestKeyringConfig:
    ...
    def test_store_credentials_success(self, temp_dir, clean_env, mock_keyring):
        ...
        mock_keyring.set_password.assert_any_call("icloud-photo-sync", "username", "new@example.com")
        mock_keyring.set_password.assert_any_call("icloud-photo-sync", "new@example.com", "new-password")
